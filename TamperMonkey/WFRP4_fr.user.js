...
.sheet-img-note {
    background: url(https://i.imgur.com/rhps6fu.png);
    background-size: 70%;
    height: 245px;
...
.sheet-img-fight {
    background: url(https://i.imgur.com/vLZUog5.png);
    background-size: 80%;
    height: 95px;
    background-repeat: no-repeat;
    background-position-x: center;
...
.sheet-img-death {
    background: url(https://i.imgur.com/174IOA3.png);
    background-size: 85%;
    height: 111px;
    background-repeat: no-repeat;
    background-position-x: center;
...
.sheet-img-dice {
    background: url(https://i.imgur.com/eS0PNwN.png);
    background-size: 100%;
    height: 111px;
    background-repeat: no-repeat;
    background-position-x: center;
...
.sheet-img-armor {
    height: 185px;
    background: url(https://i.imgur.com/nONdg6C.png);
    background-size: 50%;
    background-repeat: no-repeat;
    background-position-x: center;
}
...
.sheet-img-inventory {
    height: 120px;
    background: url(https://i.imgur.com/of913Ey.png);
    background-size: 75%;
    background-repeat: no-repeat;
    background-position-x: center;
    background-position-y: center;
...
.sheet-img-dice2 {
    height: 70px;
    background: url(https://i.imgur.com/YtScNzx.png);
    background-size: 40%;
    background-repeat: no-repeat;
    background-position-x: center;
...
.sheet-textVS {
    background: url(https://i.imgur.com/4KhMKQ5.png);
...
.sheet-texttest {
    background: url(https://i.imgur.com/O4s4z3b.png);
    background-size: contain;
    background-repeat: no-repeat;
    background-position-x: center;
    height: 50px;
...
.sheet-texttarget {
    background: url(https://i.imgur.com/YVc34cx.png);
    background-size: 44%;
    background-repeat: no-repeat;
    background-position-x: center;
    height: 50px;
...
#sheet-bronze {
    cursor: url(https://i.imgur.com/XoA8Tpp.png) 10 6, auto!important;
}

#sheet-silver {
    cursor: url(https://i.imgur.com/YUSkii5.png) 10 6, auto!important;
}

#sheet-gold {
    cursor: url(https://i.imgur.com/tmeHbUV.png) 10 6, auto!important;
}
...
.player .playercolor, .player .color_picker {
    cursor: url(https://i.imgur.com/qDmtgFp.png) 10 6, auto!important;
}
...
.ui-widget-header .ui-icon {
    cursor: url(https://i.imgur.com/u1ykhrH.png) 10 6, auto!important;
}

.ui-resizable-se {
    cursor: url(https://i.imgur.com/nkhyMYk.png) 10 6, auto!important;
...
#zoompanel select {
    width: 100px;
    cursor: url(https://i.imgur.com/LoDPkJa.png) 10 6, auto;
}

body {
    background:url(https://i.imgur.com/DssJU5n.jpg)!important;
...
#floatingtoolbar li.quickdice .quickdice-button, #floatingtoolbar li.quickdice .quickdice-toggle {
...
#floatingtoolbar, #floatingplayerbar {
    cursor: url(https://i.imgur.com/EPMx80k.png) 10 6, auto;
	background-color:hsl(0,0%,10%) !important;
...
#editinglayer li.gm_slider_box .ui-slider-handle {
    cursor: url(https://i.imgur.com/ZGrSoBD.png) 10 6, auto!important;
}
...
#page-toolbar .ui-sortable::-webkit-scrollbar {
  width: 0px;
...
#textchat .message {
    height: auto !important;
    background: url(https://i.imgur.com/HysthVj.png)!important;
...
#textchat .userscript-sharelink a {
    ...
    cursor: url(https://i.imgur.com/I3oDGM3.png) 10 6, auto!important;
}
...
.textchatcontainer .emote {
    ...
    overflow: hidden!important;
    font-family: "Caslon Antique", serif, sans-serif;
    font-style: oblique;
    line-height: 22px;
}
...
.ui-tabs .ui-tabs-nav {
    ...
    border-bottom: 10px black!important;
...
.ui-state-default,.ui-widget-content .ui-state-default,.ui-widget-header .ui-state-default {
    ...
    cursor: url(https://i.imgur.com/2T7vNzg.png) 10 6, auto!important;
}
...
.ui-dialog {
    ...
    background: url(https://i.imgur.com/HiPzWbf.png), url(https://i.imgur.com/NdmfBp9.png), url(https://i.imgur.com/Xsr7U0O.png), url(https://i.imgur.com/rgJF4IZ.jpg)!important;
    background-repeat: no-repeat !important;
    background-position-x: right, right, left, left!important;
    background-size: auto, auto, auto, auto !important;
    border-radius: 25px!important;
    background-position-y: bottom, top, bottom, top!important;
    cursor: url(https://i.imgur.com/LoDPkJa.png) 10 6, auto!important;
    box-shadow: 10px 15px 20px 2px #222;
}
...
.charsheet .repcontrol, .charsheet .repcontrol_add, .charsheet .repcontrol_edit, .charsheet .repcontrol_del, .charsheet .repcontrol_move {
    height: 25px;
    background: transparent!important;
    color: transparent!important;
    border: 0px;
...
.diceroll .didroll {
    text-shadow: 0 0 0px hsl(0,0%,0%)!important;
    color: black!important;
    cursor: url(https://i.imgur.com/DIC9KC2.png) 10 6, auto!important;
}
...
.dialog.largedialog.rollabletableeditor {
    width: auto !important;
    height: auto!important;
}

.dialog.largedialog.deckeditor {
    height: 700px;
    width: 750px;
    padding: 0px 20px;
}
...
#existingmacros .rollmacro {
    cursor: url(https://i.imgur.com/rrWZdYI.png) 10 6, auto!important;
}

span.pictos.searchinfotoggle {
...
.ui-autocomplete-input::-webkit-scrollbar {
  display: none;
}
...
a.btn.pictos.alltags.trigger {
    position: relative;
    top: 10px;
}

.nav.nav-tabs > li.active > a {
	color:rgba(0,0,0,.5) !important !important;
	font-weight: bold;
...
.listheader .title, .listheader .titleedit {
    margin-top: 4px;
    margin-bottom: 0;
    padding: 4px;
    font-size: 20px;
...
.sheet-rolltemplate-5e-shaped .sheet-gm-info-inline-block {
	background-color:hsl0,0%,0%)!important;
}
...
img[src='/images/handout.png'] {
	content: url(https://i.imgur.com/UBzGtHO.png)!important;
}

img[src='/images/character.png'] {
	content: url(https://i.imgur.com/iFFMVUp.png)!important;
}
